...
@section('content')
   ...
   @breadCrumb(array('首页'=>'/','添加'=>'/product/add'))
   <div class="row">
                ...
                <form  role="form">
                  ...
                  <div class="form-group col-md-8 input-group">
                    ...
                    <div class="form-group col-md-8 input-group">
                        ...
                        <input type="date" class="form-control" placeholder="请输入鹦鹉的显性基因(可选)" name="productDominantGene">
                    </div>
                    <div class="form-group col-md-8 input-group">
                         <span class="input-group-addon">隐性基因：</span>
                        <input type="date" class="form-control" placeholder="请输入鹦鹉的显性基因(可选)" name="productImplicitGene">
                    </div>
                    <div class="form-group col-md-8 input-group">
