...
<head>
    ...
    <style>
        @font-face {
            ...
            font-style: normal;
            font-weight: 400;
            src: local('Audiowide'), local('Audiowide-Regular'), url(/fonts/google-fonts-Audiowide-Regular.woff) format('woff');
        }
        @font-face {
            font-family: 'Creepster';
            font-style: normal;
            font-weight: 400;
            src: local('Creepster'), local('Creepster-Regular'), url(/fonts/google-fonts-Creepster-Regular.woff) format('woff');
        }
        * {
            margin: 0;
            padding: 0;
