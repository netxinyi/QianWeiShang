...
class Client
{
    ...
    public function __construct($params = array())
    {
        ...
        self::$dicEndpoints  = $this->params['endpoint'];
    }
    ...
    {
        $index = self::extractArgument($params, 'index');


        $type = self::extractArgument($params, 'type');


        $body = self::extractArgument($params, 'body');

        /** @var callback $endpointBuilder */
        $endpointBuilder = self::$dicEndpoints;
